...
const Navbar = () => {
    ...
    return (
        <nav className="fixed m-4 top-0 right-0 left-0 shadow-lg z-50 bg-white">
            <div className="container px-4 flex justify-between item-center h-16">
                <h3 className="text-2xl font-bold mt-3.5">Travel</h3>
                <div className="hidden md:flex space-x-4 text-sm font-bold items-center">
                    ...
                    <button className="py-2 bg-gray-300 px-6 border">Login</button>
                </div>
